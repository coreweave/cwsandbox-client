...
"""Integration tests for cwsandbox._sandbox module.

These tests require a running CWSandbox backend.
...
def test_sandbox_list_include_stopped(sandbox_defaults: SandboxDefaults) -> None:
    ...
    assert matched_sb is not None, f"Stopped sandbox {sandbox_id} not found with include_stopped=True"
