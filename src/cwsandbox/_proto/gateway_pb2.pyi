...
class ListSandboxesRequest(_message.Message):
    ...
    def __init__(self, tags: _Optional[_Iterable[str]] = ..., status: _Optional[_Union[SandboxStatus, str]] = ..., profile_ids: _Optional[_Iterable[str]] = ..., runner_ids: _Optional[_Iterable[str]] = ..., max_timeout_seconds: _Optional[int] = ..., include_stopped: _Optional[bool] = ...) -> None: ...
...
class ObjectStorageWIFConfig(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., wif_config_id: _Optional[str] = ..., enabled: _Optional[bool] = ..., allowed_buckets: _Optional[_Iterable[str]] = ..., max_permission: _Optional[_Union[ObjectStoragePermission, str]] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class SetObjectStorageWIFConfigRequest(_message.Message):
    ...
    allowed_buckets: _containers.RepeatedScalarFieldContainer[str]
    max_permission: ObjectStoragePermission
    def __init__(self, wif_config_id: _Optional[str] = ..., enabled: _Optional[bool] = ..., allowed_buckets: _Optional[_Iterable[str]] = ..., max_permission: _Optional[_Union[ObjectStoragePermission, str]] = ...) -> None: ...
