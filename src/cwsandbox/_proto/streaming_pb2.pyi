...
class ExecStreamInit(_message.Message):
    __slots__ = ("sandbox_id", "command", "tty", "tty_width", "tty_height", "env", "resume_session_id")
    ...
    def __init__(self, sandbox_id: _Optional[str] = ..., command: _Optional[_Iterable[str]] = ..., tty: bool = ..., tty_width: _Optional[int] = ..., tty_height: _Optional[int] = ..., env: _Optional[_Mapping[str, str]] = ..., resume_session_id: _Optional[str] = ...) -> None: ...
...
class StreamingExecReady(_message.Message):
    __slots__ = ("ready_at", "session_id")
    READY_AT_FIELD_NUMBER: _ClassVar[int]
    SESSION_ID_FIELD_NUMBER: _ClassVar[int]
    ready_at: _timestamp_pb2.Timestamp
    session_id: str
    def __init__(self, ready_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., session_id: _Optional[str] = ...) -> None: ...
...
class LogStreamInit(_message.Message):
    __slots__ = ("sandbox_id", "follow", "tail_lines", "since_time", "timestamps", "resume_session_id", "resume_offset")
    SANDBOX_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    resume_session_id: str
    resume_offset: int
    def __init__(self, sandbox_id: _Optional[str] = ..., follow: bool = ..., tail_lines: _Optional[int] = ..., since_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., timestamps: bool = ..., resume_session_id: _Optional[str] = ..., resume_offset: _Optional[int] = ...) -> None: ...
...
class LogStreamData(_message.Message):
    __slots__ = ("data", "timestamp", "session_id", "offset")
    DATA_FIELD_NUMBER: _ClassVar[int]
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    SESSION_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    session_id: str
    offset: int
    def __init__(self, data: _Optional[bytes] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., session_id: _Optional[str] = ..., offset: _Optional[int] = ...) -> None: ...
